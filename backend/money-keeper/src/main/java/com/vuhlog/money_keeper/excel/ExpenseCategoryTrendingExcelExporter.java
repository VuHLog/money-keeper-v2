...
public class ExpenseCategoryTrendingExcelExporter {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<ReportExpenseCategory> data;
    private ReportFilterOptionsRequest request;

    public ExpenseCategoryTrendingExcelExporter(List<ReportExpenseCategory> data) {
        this.data = data;
    ...
    private void setupPageProperties(ReportFilterOptionsRequest request) {
        ...
        header.setCenter("BÁO CÁO XU HƯỚNG CHI TIÊU THEO DANH MỤC CHI" + timeRangeTitle);
    ...
    private void writeDataRows() {
        ...
        for (ReportExpenseCategory item : data) {
            ...
            Long amount = item.getTotalExpense();

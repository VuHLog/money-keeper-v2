...
import com.vuhlog.money_keeper.dto.response.responseinterface.report.ReportYearlyTrend;
...
public class YearlyTrendExcelExporter {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<ReportYearlyTrend> data;
    private ReportFilterOptionsRequest request;
    private List<String> timeArr = new ArrayList<>();
    private String transactionType = "";

    public YearlyTrendExcelExporter(List<ReportYearlyTrend> data) {
        this.data = data;
    ...
    private void setupPageProperties(ReportFilterOptionsRequest request) {
        ...
        header.setCenter("BÁO CÁO XU HƯỚNG " + this.transactionType.toUpperCase() + " THEO NĂM");
    ...
    private void writeDataRows() {
        ...
        Map<String, ReportYearlyTrend> dataMap = new HashMap<>();
        for (ReportYearlyTrend report : data) {
            String time = report.getYear();
        ...
        for (String time : timeArr) {
            ...
            ReportYearlyTrend reportYearlyTrend = dataMap.get(time);

            cell = row.createCell(1);
            cell.setCellValue(reportYearlyTrend != null ? reportYearlyTrend.getTotal() : 0);
    ...
    private void addSummaryRow(int rowIndex) {
        ...
        for (ReportYearlyTrend reportYearlyTrend : data) {
            total += reportYearlyTrend.getTotal();
        }
    ...
    private void addTitleToSheet(ReportFilterOptionsRequest request) {
        ...
        titleCell.setCellValue("BÁO CÁO XU HƯỚNG " + this.transactionType.toUpperCase() + " THEO NĂM");
